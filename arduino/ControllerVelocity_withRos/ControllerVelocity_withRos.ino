...
void setup() {
  ...
  attachInterrupt(digitalPinToInterrupt(ENCR_A), countEncoder_r, RISING);
  ...
  attachInterrupt(digitalPinToInterrupt(ENCL_A), countEncoder_l, RISING);
